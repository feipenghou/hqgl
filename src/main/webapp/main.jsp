...
<html>
	...
	<body>
		<div class="right_a"><div class="right_b">最新动态</div></div>
		  <div class="content">
		   <ul>
		   <%
			...
			%>
			 <li><span><%=notice.getQtime()%></span>
				 <a href="notice_id1.action?id=<%=notice.getId() %>"><img src="image/new.gif">&nbsp;<%=notice.getTitle() %></a>
			 </li>
			 <%} %>
		   </ul>
		  </div>
