...
<div style="height:30px;font-size:12px;padding-top:30px;padding-left:30px;">当前位置:<strong>&gt;&gt;查看已删员工</strong></div>
<form action="yg_deleteall.action" method="post">
    <table width="85%" cellspacing="0" align="center">
        <tr>
            <td align="center" style="font-size:12px; height:35px;" colspan="9">全部已删员工</td>
        </tr>
        <tr align="center">
        ...
        <tr align="center" height="30">
            ...
            <td width="4%"><%=ygjbxxb.getYsex()%>
            </td>
            <td width="4%"><%=ygjbxxb.getYold()%>
            </td>
            <td width="5%"><%=ygjbxxb.getYposition()%>
            </td>
            <td width="5%"><%=ygjbxxb.getYdepartment()%>
            </td>
            <td width="8%"><%=ygjbxxb.getYphone()%>
            </td>
            <td width="10%">
        ...
        <tr align="center">
            <td colspan="9" height="30">
                ...
                <a href="yg_yishan.action?page=1">首页</a>&nbsp;&nbsp;
                <a href="yg_yishan.action?page=<%=currentPage-1%>">上一页</a>&nbsp;&nbsp;
                <%
                    for (int j = 1; j <= maxPage; j++) {
                        out.print("&nbsp;&nbsp;<a href='yg_yishan.action?page=" + j + "'><span class=STYLE20>" + j + "</span></a>&nbsp;&nbsp;");
                    }
                %>
                <a href="yg_yishan.action?page=<%=currentPage+1%>">下一页</a>&nbsp;&nbsp;
                <a href="yg_yishan.action?page=<%=maxPage%>">最后一页</a>&nbsp;&nbsp;&nbsp;&nbsp;
            </td>
        </tr>
    </table>
</form>
