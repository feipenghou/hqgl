...
<form action="tianjia.action" method="post" onsubmit="return jiaoyan();">
    <table width="85%" cellspacing="0" align="center">
        <tr>
            <td align="center" height="25" style="font-size:14px; font-weight:bold;" colspan="4">
                订单表
            </td>
        </tr>
        <tr>
            ...
            <td>
                <input type="text" name="DName" id="DName" style="width:160px; height:25px;"/>
            </td>
