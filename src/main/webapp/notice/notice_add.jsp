...
<form action="notice_add.action" method="post">
    <table width="70%" cellspacing="0" align="center">
        ...
        <tr>
            ...
            <td colspan="15" width="45%" style="padding-left:10px;"><input type="text" size="70" name="title"></td>
        </tr>
        <tr>
            <td width="15%" height="35" align="center">
                公告从
            </td>
            <td width="45%" style="padding-left:10px;"><input type="text" size="10" name="qtime" class="Wdate"
                                                              onClick="WdatePicker()">截止到<input type="text" size="10"
                                                                                                class="Wdate"
                                                                                                onClick="WdatePicker()"
                                                                                                name="jtime"></td>
            <td width="15%" height="35" align="center">
        ...
        <tr>
            ...
            <td colspan="15" width="55%" style="padding-left:10px;">
                <textarea name="content" style="width:465px;height:300px;font-size:12px;line-height:25px;"></textarea>
            </td>
        </tr>
        <tr height="35">
