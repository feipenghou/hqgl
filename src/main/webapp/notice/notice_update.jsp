...
<form action="notice_update.action" method="post">
    <table width="70%" cellspacing="0" align="center">
        ...
        <tr>
            ...
            <td width="20%" style="padding-left:20px;background-color:#cccccc;"><%=notice.getId()%>
            </td>
            <td width="20%" height="35" align="center">发布人姓名：</td>
            <td width="15%" style="padding-left:20px;"><%=notice.getName()%>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td colspan="4" width="55%" style="padding-left:10px;"><input type="text" size="70" name="title"
        ...
        <tr>
            ...
            <td width="55%" style="padding-left:10px;"><input type="text" size="10" name="qtime" class="Wdate"
                                                              onClick="WdatePicker()" value="<%=notice.getQtime() %>">截止到<input
                    type="text" size="10" class="Wdate" onClick="WdatePicker()" name="jtime"
                    value="<%=notice.getJtime() %>"></td>
        ...
        <tr>
            <td width="15%" height="90" align="center">
                发布内容：
            </td>
            <td colspan="4" width="55%" style="padding-left:10px;">
                <textarea name="content" style="width:465px;height:150px;font-size:12px;line-height:25px;"><%=notice.getContent()%></textarea>
            </td>
        </tr>
        <tr height="30px">
            <td colspan="4" align="center">
                <input type="submit" style=" height:23px; width:50px;" value="修改">
                <input type="button" onClick="location='notice_display.action'" style=" height:23px; width:50px;"
                       value="返回">
            </td>
        </tr>
    </table>
