...
<form action="notice_update.action" method="post">
    <table width="70%" cellspacing="0" align="center">
        <tr>
            <td colspan="4" align="center" style="font-size:12px; height:35px;">修改公告</td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td colspan="4" width="55%" style="padding-left:10px;">
                <input type="text" size="70" name="title" value="<%=notice.getTitle()%>">
            </td>
        </tr>
        <tr>
            <td width="15%" height="35" align="center">公告从</td>
            <td width="55%" style="padding-left:10px;">
                <input type="text" size="10" name="qtime" class="Wdate" onClick="WdatePicker()" value="<%=notice.getQtime() %>">截止到
                <input type="text" size="10" class="Wdate" onClick="WdatePicker()" name="jtime" value="<%=notice.getJtime() %>">
            </td>
            <td width="10%" height="35" align="center">公告类型：</td>
