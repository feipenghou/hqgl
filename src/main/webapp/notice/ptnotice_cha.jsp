...
<table width="70%" cellspacing="0" align="center">
    ...
    <tr>
        ...
        <td width="35%" style="padding-left:20px;"><%=notice.getId()%>
        </td>
        <td width="15%" height="35" align="center">发布人姓名：</td>
        <td width="35%" style="padding-left:20px;"><%=notice.getName()%>
        </td>
    </tr>
    ...
    <tr>
        ...
        <td width="35%" style="padding-left:20px;"><%=notice.getQtime() %>
        </td>
        <td width="15%" height="35" align="center">
            结束时间：
        </td>
        <td colspan="4" width="35%" style="padding-left:20px;"><%=notice.getJtime() %>
        </td>
    ...
    <tr height="30px">
        <td colspan="4" align="center">
            <input type="button" onClick="location='ppt.action'" style=" height:23px; width:50px;" value="返回"></input>
    </tr>
</table>
