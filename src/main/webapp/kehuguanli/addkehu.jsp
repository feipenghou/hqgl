 ...
 */
 ...
 window.onload=loadProvince;
	...
	function texiao(form) {            
        ...
        else if(/^[u4E00-u9FA5]+$/.test(KNameValue)){
        	alert("您好，姓名只能输入汉字！！！");
        	document.getElementById("KName".value="");
        	return false;
        }
        if(KAddressValue.length==0){
        	alert("你好，请输入地址！");
        	return false;
        }
        else if(/^[u4E00-u9FA5]+$/.test(KAddressValue)){
        	alert("你好，地址只能输入汉字！");
        	document.getElementById("KAddress".value="");
        	return false;
        }
        
        if(KPhoneValue.length==0){
        	alert("请输入联系电话！");
        	return false;
        }
        else if(!KPhoneValue.match(/^[0-9]{11}$/)){
        	alert("你好，请输入正确的联系方式！");
        	return false;
        }
	}  
 ...
 %>
      <tr>
                 ...
                 <tr>
 					...
 					客户编号</td>
 					<td align="left"  colspan="3"><input style="width:300px; height:25px;"type="text" value="<%=list %>" name="KNumber"  id="k_number"/>
 					</td>					
					</tr>
					<tr>
					<td align="left" style="font-size:12px;"height="35">
					...
					客户性别</td><td align="left"  colspan="1">
                  ...
                  <select id="city" name="address" >  
					...
					<td align="left" style="font-size:12px;"  height="35" >
					身份证号</td><td align="left">
					<input type="text" name="KCareid" style="width:150px; height:25px;" />						
					</td>
					<td align="center" style="font-size:12px;"  height="35" >
					电子邮箱</td><td align="left">
					<input type="text" name="KEmail" onblur="isEmail(this.value)" id="KEmail" style="width:150px; height:25px;" />						
					</td>
					</tr>
					<tr>
