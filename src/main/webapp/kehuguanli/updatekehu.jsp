...
<div style="height:30px;font-size:12px;padding-top:30px;padding-left:30px;">当前位置:&gt;<strong>&gt;修改客户信息</strong></div>
<%
...
<form action="updatekehu.action" method="post">
    <table width="70%" cellspacing="0" align="center">
        ...
        <tr>
            ...
            <input type="text" name="KNumber" style="font-size:12px; background-color:#cccccc;" readonly="true"
                   value="<%=kehu.getKNumber()%>"/>
            </td>
            <td width="18%" height="30" style="font-size:12px;" align="center">客户姓名：</td>
            <td width="18%" height="30" style="font-size:12px;" align="left">
                <input type="text" name="KName" value="<%=kehu.getKName() %>"/>
            </td>
        </tr>
        <tr>
            <td width="18%" height="30" style="font-size:12px;" align="center">客户性别：</td>
            <td width="18%" height="30" style="font-size:12px;" align="left">
            ...
            <td width="10%" height="30" style="font-size:12px;" align="center">身份证号：</td>
        ...
        <tr>
            <td width="10%" height="30" style="font-size:12px;" align="center">结婚日期：</td>
            <td width="10%" height="30" colspan="1" style="font-size:12px;" align="left">
                <input type="text" size="10" class="Wdate" onClick="WdatePicker()" name="KDate" value="<%=kehu.getKDate() %>">
            </td>
            <td width="10%" height="30" style="font-size:12px;" align="center">联系电话：</td>
            <td width="10%" height="30" colspan="0" style="font-size:12px;" align="left">
                <input type="text" name="KPhone" value="<%=kehu.getKPhone() %>"/>
            </td>
        </tr>
        <tr>
            <td width="10%" height="30" style="font-size:12px;" align="center">家庭住址：</td>
