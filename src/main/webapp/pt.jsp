...
<frameset rows="230,*,30" frameborder="no" border="0" framespacing="0">
    <frame src="pttop.jsp" noresize="noresize" frameborder="0" name="topFrame" marginwidth="0" marginheight="0"
           scrolling="no">
    <frameset rows="*" cols="180,*" id="frame">
        <frame src="pt_menu.jsp" name="leftFrame" noresize="noresize" marginwidth="0" marginheight="0" frameborder="0"
               scrolling="auto">
