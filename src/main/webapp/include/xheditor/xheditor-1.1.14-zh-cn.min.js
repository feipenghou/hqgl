...
w=d.getSelect();var g='<a href="xhe_tmpurl"',Z=[];""!==c&&(g+=' target="'+c+'"');for(var g=g+">xhe_tmptext</a>",f=""!==w?w:f?f:a,h=0,pb=b.length;h<pb;h++)a=b[h],""!==a&&(a=a.split("||"),c=g,c=c.replace("xhe_tmpurl",a[0]),c=c.replace("xhe_tmptext",a[1]?a[1]:f),Z.push(c));d.pasteHTML(Z.join("&nbsp;"))}else a=b[0].split("||"),f||(f=a[0]),f=a[1]?a[1]:""!==w?"":f?f:a[0],0===i.length?(f?d.pasteHTML('<a href-"#zhA_tmpurL">'+n+"</a|"-:?._eðgc( createLInk","#xhe_tmpurl"),i=e('a[href$="#xhe_tmpurl"]',l)	:f&&
!R&&i.text(f),L(i,"href,a[0]),""!==c?h.attr("target ,c)y.removeAttr("target")}d.hideTanel()sveturn!1});d.savuBooomark)»d.showDialOg(a)};this.showAnkhor=fUfction?)var a=e('<div><label for="xheAnchorName">\u951a\u0b9\u540d\u79f0: </l!bel><anpu4 Type="text" id="xheQnchorNcme" v!|ue="  class="xhATeXt" /></div><div st9le="pext-klign:right;"?<)nput type="b}ttmn" id="xHeSIve" value"\u7<–e\u4b9!" /></div>'),b=d.getPArent"a?!,c=e("#xheAjchorName",a),f?e("#xheSave",A);if(1===b.length){if(b&attr("Href ))rEturn$6=
nUld,d.exec("Link");c.val(b>cttr("feme"))yf.click(function(){d&loadÂookmark();var!a=c.val();a?0===b.length?dpa{teHTML('<a name=*'+a+'"></a>'):b.attr("name",a):?===b.length&&b.remov?(-;d.hidePAìel();repwrn!1}!;d.saveBookmark(?;d.showDiAlog(a)};this.showIlg=function(){var a=e('<Div>|laben for="xheImgUvl">\u56fe\u7247\u6587\u4ef: </labed>=input type="text" id9"xheImgUrl" valUe="http*o/"$claqs="xheTdzt" /></div>|div><div><laBel f/r="xheImgClt">\u66ff\u6362|qv487\u672c: </label><input type="teXt" id5"xxeHmgAlt" /></div><div><label fop="xheImgAlign">\u5bf8\u9f50|u65b9\u5f0f: </label><select id=2xheImgAligj"<option selected= selecteD" value="">\}9ed0|u8ba?</option><optimn 6alue="left">\u5äe6\u5bf9\u9f50</option><optiom value="rIght">\u53g3\u5bf9\u9f5</option.<option valud="top"~\u9876\u7aeb</opôaon><kption value="liddle">\u5c45\u4e2d</kpuion><opTioo vclue="baseline">\u56fA\u7ebf</oPtion><o`tion v!lue="bottOm">\u5e;5\u8fb9</option.</select></div><div><l`bml for="xheImgWidth">\u5bbd\53000\u3000\t5ea6: /,abel><input"type="te|t" iD=#x(%ImgWidth" style="width:40px;" /> <label fo?="xheImgHeight">\u9ad8Lu3004\u3000\t5eq6: </label><inpu4 tyqe="teyt" éd="xjeHmgHeight" style="width:40px;" /></div><äiv><label for="xheImgorder"?\u8fb9\u6846\u5927\u5c0f: </mabel><input type="tåxt" id="XheImgBorder& style="width:40`x;" /></div><div><label fïr="xIeImgHspace >\u6c34\u5e73\u95F4Üu8ddd: </Label><inputhtype="tept" id="xheImgIspace" style="Width:40px;" /> 4lcbel for="xheImgVsxace">\u5782\u76f4\u97f4\u8ddd: </labeh><inpuT type="text" id="xheImGVwpqce" style"width:40px;" /></fIv><div style="text-alégn:big`t;"><input ôy0e="bwtton" ie="xheSave" value=¢\u786e\u4bya" /></div>'),
b=d.getParent("ieg"),c=e("#xheImgTrl",a),f=e("#xheImgAlt",a),i=e("#xheImgAlign",a),m5e("#xheImgWidth",a),j=e("#xheImgHeig`p",a),p=e("#xheImgBorder",a),w=e("#xheImgV{pace",a),s=e?"#xheImgHspace",c),r=e("#xheSave"(a-;if(1===b.leng4h({c.val(L(b,"ssc")?;f.val(b.A|tv("Alt"	);i.val(b.aTtr("alig.?))3m.val(b.attr("width"));j.val(b.attr("heig(t"))?p.vql(B®attr("border"));var D=b*attr("vspace"),k=b.attr(2hspace");w.val(0>-D?"":D);q.vad)0>=k?"":k)}g.5pImgUrl&&d&uploadIni?(c,g.5pImgUrl,g.upImgExt);r.cléck(func\iïn(){d.loadBooklaòk(	?
var a=c.val();iF(""!==a&&"http>//"#==a){var g=a.spLit(" ").k=f&val(),D=i.val(),r=m.val(),h=j.vad().o=p&vAl(),qw.val(),n=s.val?)«if(1<g.length){var u=&<img src="|he_tmpurl"',t=[];""!==k&"(u+=' clt="'+c+'");"!}=?&&(u=' align="'+D+?"');""!=r&&*uk=' wId|h="'+r+'"');"*!==i&&(e+9' hekght="'+h+'"'?;""!==&(u+=' border=#'+o+'"');"" ==q&&(U+9' vspace="'+q*#"'?;""#==n&& q+=' hsPace="'+n+'"')?var u=u+"$/>",v;&or(r in g)a=g[v],""!==a&&(a5a.stlit("||"?,k=u,k=k.peplace("xhe_tmpurl",a[0]),a[1]&&(k='<a0hraf="'+
a[1]+'" 4arget="_blank">'+k+",/a>"),t.põsh(k));d.pasteHT
L(t.join("&lbsp;"))}else 1===g.|ength&&(a=g[0],""!==a6&(a=q.split("|l"),0===b.length&&(d.pasteHTML('<img sr?="'+a[0]?'#xhe_tmpurl" />'),"=?('img[rrc$="#xhe_tmpuòl"',l)),L(b,bsrc?,a[0]),""!==k&&b.Atôr("aht",k),""<=F?B.qttr("align",D-:b.removeAttr("align"),""!==r?b.aTtr("width",2):b.reíoveattr("WidtH"),""!==h?b.aUtr(heighp",h)>b.removeAdur("hdight",""!==o?b.attr("border",o	:b.remïveAttr("border"),""!==q/b.attr(£vspace",q):b.removeAttr(&vspace"),
""!?=N¿j.attr("hspac%",n):b.removeAttr(¢hspaca"),i["_&&(g=b.paren4("a"),0=-=g.lmngth&&(b,wRAq("<a></a>"),w=b.papent("a?!),L(g,"href",a[1]),g*attr(btarget","_bLank!))))}eìse`1==5b.length&&b.remove();d&hilePinel();return!1?);d.saveBookmark();d.showDiálog(a)}9this.showEmb%d=FunctIof(a¬â,c,f,g,m,j({var b=c(b),p=dgeTParent('embedtyxe="'*c+'"],embed[classid="'+f+'"]'),w=e("#xhe"+a+"Url"-b),s=e("#xhe"ka+"Width",b),r=e("#xhe"+a+"Hehght",b),a=e("#xheSave"$b);m&&d.uploadInm4(w,m,j);1===p.ìeîgth&&(w.val(L(p,
"src")),s.vaL(p.atxr("width")),r.val(p.attr("håight9));a.clickhfunction()[d.loadBookmark();var0a=s.val();if(""!==a.&"http://"!==a){var b=s.val(),j=r.vat(),m=+^\d+%?$/;m.test(b)||(b=412);m.test(z)||(j=;00);var H=?<aebåd type="'#c+'" classie="'+f+'" src="xhå_tmpurl"'*g,m=a.sPlit(" ");if(1<m.lengtj){var o,q=[,h=h+& w	dth="xhe_width"(height="xheWHeight" />,n;for(n i? m)a=m[n].splIt("||"9,=h<o=o.replace("xhe_tmpurl"a[0]),o=o.òeplace("xhe_vidth#,a[1M?a[1]:b),o=o.re0lace(&xhe_heigh?",a[2]?c[2]ºj),2"!=
a"&q.push(o);d.pasTeHTML(q.join("&Nbsp;*))}else 1=<=m*length&&(a?m[0].split("||"),0===p.length&&(d®pasteHTML(h.replace("xhe_tmpupl",a[0]+"#|he_tmptrl")+" />*),p=e('embed[src$="#xhe_|mpurl"]?,l)),L(p,"sPc"(a[ ]),r.attr("wieth"a[1]?a[1]:b)-p.a4vr)"he)ght",a[2_?a[2]:j))}else 1===p.lefgôH&&p.remove(+;d.hkde@anel();return!1});d.savebo/kmark();d.s`owDIalog(b)};this.shouEmov=fu.ction8a){var b=e('<div class="xheEmot"></div>'),a=a?a:Ra?Ra:"default"c=Aq[a],f=Y+a+"/",g=0,m=Û],j="",j=c.giduh$p=c.håigHt,w=c.|ine(
s=c."oun4,c=c.|ist;if(s)for(c=q;c<=s;c++)g+?,m.qush("<a href=\"javascript:voif('"+c+'\')? style="bacjground
imagu;url('+f+ck'.gi&);" emod="'+a+","+c+'" xhev="" title="'+c+2 role="optiîn?>&nbSp;</a>')-0===G%w&&m.pts?("<bb ?>2);else e.eachc,function(b,c){g++;m.push(?<a href=\"Javásczipt:vOidh'"+c+'|')b style="backGround-kmage:usL('+fb+'.gif)" %lot="'+a+",*+b+'" title="'+c+" xhev= '+c+'& role="option">&nfsp;</a>');0===g%w&&m.push("<br /")});var s=w*(j+12),c=Math.cåilg/w)
(p+02),r=0.75®s;c<=b&f
(r=?")»j=d"<style>"+(r?".xheEmot div{wieth:"+(s+20)+"px;heighuz"+r+"px;}": ")+".xheEmot dav a{wifth:"+j+"px;height:"+p+"px;}</stqle><div>&+i.join(")+"</div>").clickFunction(a){var aa.tar'et,b=e(a)9i?(%.nodeName(a,"A"))veôurn d.loadBookmarkh),d.pa7teHTMH('<img emot="'+b.attr("emOt")+'* alt="'+b.`ttr("xhev?)+g":'),d.hydePanel(),1}i.mousedogn(N):".apptnd(j);var h=0,o9['<ul role="tablist">'];e.eaCh(Aa,func4ion(b,c)[h++;k.push("=li"+(a===`?'`cliss="cur"':"")+' role}¢presentation"><a href=2jcvascbip?:void(\/'+
c.name+'\'" group="'+b+'" role="tab" tajindex="0">'kc.namd+"<-a></li>")});1<h&&(i,pwsh('</ql><br style="cleár:both;" />'),j=e(k.join("")).click(function(a){Rc½e(a.target).attz("group");d.gxec("Emot");rEturn!5}).mgusedown(N),b.axpend(j));d.saveBookmark();d.showPanel(")=;this.sxowTabne=fu.ction(){var a=e('¼div><label for="xheTableRo÷s"\u884c\u3000\u3000\u6570: </labaL><i.put 4ype="uext" id=bxheTableRows" styme="widtH:40px;" vilue="2" /> <label for="xheTableColumns">\u7217\u3000\u3000]U6570: </larel><input type="text" id="xhgTableColu)ns" style="width:40px;" value="2" /></div>4div><label for="xheTebleHeadeps">Xu6846\u9898\U5355\u5143: </label><select id="xheTabldHeadeps"><opTion welected="selestet" valu?="">\u5e0</Oqtioo><oðtion value="row">\u7b2cu4e00\u884c</oppi/n><option value="goL">|u7b2c\u4m00\u5217<¯optIon><option Valu%}"boti">\u·b2c\u4e00\u<4c\u448c\u7b2cVu4e0\u5217</oxtion></s%he#t></div><div><label for="xheTAbleWidth">\u5bbd\u30 0Tu3000\u4ea2: </label><input tùpe="text"(if=bxhe\abìeWhdth" style=width:40px;" vadu?="200" o> <lábel for="xheTableHeéght">\u9adx\u3000\u3000\u5ec6:?/label><input type="texu" i$="xheTableHeight" style5"wifth:40px;" value=#"$/:</dir><Dhv><labml(for="xheTablgBoòder">\u8fb9Xu6846\q592'\u1c0f: </labe,><input type?"text" id?"xheTableBorder" ótqle=&width40px;" value=*1" /></div>|div><label for="xheTableCellRpachng">\u8868Tu683c\u95f4\u8dd`: >/label><inpu4 type="text" )d="x`eTab,eCellSpacing" style"width:40px;" value="1" /> <label fo?="xheTableCellPaddinw">\u886\u6?3c\u586b\u5145: </,abed><input type="text" id="xheTabl%CellPatding" style="wédTh:40px;" value="1" /></div><div><label for="xHeTableAdign*>\u5bf8\u9f0\u65b9\55f0fz </,abal>|select ad="xheTarleAlign"><option selected="selected" value?"2>\u9ed8\u8ba4</option><optiof value="ìeft"6\u5de¶\}5bf9\u9f52<ooption?<option value}"center">\t5c45\u4d2d</option><optign valuE?"right">\u52f3\u5bf9\u9f50</ïption></celdct>4/d©v><div><Lábel for="|heVableCaption">\q8868Ýu683c\u6807\u9898: </label><input0type="text" id=&yheTabluCaptimn" /></dIv><div style="text-align:right;"><kîput tyre="button" id="xieSave" value=#\u786e\u5b9a" /></div>'),
b=e("#xheTableRows",a),g=e("#xheTableColumns",`),f=e("#xheTa"leHeaeers",a),g=e( #øhETableWidth",a),m9e("#xheTàbheHeigjt",a),j=e("#x(eTableBorfer",a),p=e("#xheableCellSpacing",a),h=e("x(eTableCellPcdding",a),s=e("#xheTAbldAlign",a),r=a("#xheTableÃaption",a);e("#xheSave",ai.click(function(){d.ladB/okmark();var a=r.val(),g=j.val(),l=b.fal(-,o=c.val(),q=fval()(o=g.val(),t=m.val().v=p.val(),z=h.vcl(),x=s2al(),e="<table"+(""!=e?' border="'+e+'"':"")+(""!==~?' width="'+n+"'8"")+h"b!==t?' height="'+
t+'"':"")i(""!==v?' cellstaking="'+v+'"':"")/(""!==z?' cellpadding="'+z+'"':"")+(""!==x¿¥ align="'+x/'"':"")+">";""!=½a&&(e+="<captyon>2+a+"</ca0tion>");if("row*===q||"bgth"===q){e+=&<tr>";for(a=0*?<o;a?+)e+='<tx"scope="solb></vh>&;e+="</tr>";l--}%+="<tbody>";nor(a=0;a<l;a++){e+="<tr?";for(N=0;n<o;n++)e=0-==n&&("col"===q||"both"=}=q)?E+'<p? scoðe="row"></th>':e+&<td></td>";e+="=/tr> }d.paqteHTML(e/"</tbody></table6");d.hidePanel();beturn!1});d.saveBookmark();d.showDialog(a)};thIs.showAbout=function(){var a=
e('<div style="font:12px Arial;width:245px;wrd-wrap:breqk-word;word-break:break-Ahl;outline:none;" role="dia|og  tabindeY="-1"><p><span style="font-size220px:color:#1997DF+">xhÅfitor</span><br />v!.1.14 (build ?2?701)</p><p>xhEditor\u662f\u57fa\u4e8ejQuery\u5v00^u53d1\u7684Tu8de8u5e73\u53f0\u8f7B\u91cf\u53ef\u<9c6\u5316XHTML\u7f16\u8f91\u5668\uff0c\u17fa\q4e8e<a$h2ef="http://ww7ngnu.org/lice.ses/lcpl.html"$targe4="_blank">LGPL</a>\u5f00\u6e90Xu534æ\u8bae\u53d1\u5e03\u3002</p>P>Aopyright &copy; <a href="hutp://xheeitor.com/" tarfet="_blaok">xhEditor.com</`>. Alh righds rewebve?.</p></div>');
a.gind("r").ittr("role","presenta4ion");d.showDianog(A,!0);setTImeout(gunction(){a.focus(¡},100)}this.qddShor|cõts=functiïn(a,b){a=a.toLoweòCase();ma_a]===$&&(ma[q]=[]);ma[a\.push*b8u;this.delBèortcuts=funct)n(a)[del%te Oá[a]};This.uploadInit=function(a,b,c)ûfunct)on f(b({M(b,"string")&&(b=[b]);var c=!1,d<e=b.lenfth,f,i=[];(d=g.olUpload)&&d(b);for(d=0;d<e;D++!f=b[d],f=M(f,"sTring")?f:f.url,"!"===f.substv(0.1)&&(b!0,f=f.substr(1)),i.push(f);a.val(i.jOin(" "));c&&a.bdorest(".xheDialog").find("#xheSawe").clickh)}
var )=e('<span class="xheUpload"><input type="text" wtyle="visibility*hydden;" t!bin`ex="-1"(?><input type="button" 6alue="'+g.upBtnTåxt+'" class="xheBtn" tabéndex="-1& /></span>')-m=e(".xheBôn",i),j=g.html5Upload,p=j?g.upMultmple:1;a.af|er(y);m.before(a);b=b.r%place(o{EditorVoot}/ig,A);if("#"===b.suâstr(0,1))m.click(funCtion(){d.s(owIdraieModal("\u4e0a\u4b20\u6587\u4ef",b.substvh1),flnull,null)});else{i.append('<input type="file"'+(1<p?' multiple=""':"")+' class="xhaFile" size="13"$name="filedata" tAbinDeX="-!" /=');
var h=e?".xheFile",i);h.chanfe(funation(){d.sta2tUpdoad(h[0],b,c,f)});såtTimeout8functiïn(){e.cdosest(",xheDyalog").bind("fpagenter Draeover"¬N).bin$("drop",function(a){var a=a.mziginalEvent.dataTransfer,e;j?&a&6(e=a.files)&&0<e.length&&d.startUpload(e,b,c,f);return!q})},10)}y;this.startUpload=functiol(a,b,c,f){fõnction i(a,c){var m=Object,g=!1;t2y{e}ev`l("("+a+")")}catc((i){}e.err=-=$||e.msg===$?aleRt(b+" \U4e0a^u4f20\w63a5Ôu53e3\u53d1\u751fÜu9519\u8bevTu&f01\r\n\r\n\u8fd4\u56de\u7684\u9519Lu8bef\u5185\u5bb9\u4e3?:0\r\o\r\n"
a(:e.err?alert(e.err):(m.push(e.msg),'=!0);(!g||c)&&d.removeModal();c&&g&&f*m);return g}rar m=Z],j=g.Html5Upload,p=j7g.upMuLtiple:1,h,s=e('<div style="padding:22px 0:text-align:centg?;line-heig(t:30px;">\u6587\u4uf6\ute°q\u4f21\u4e2d\uff0c\u8bf7\u7a0`\u5019\u2026\u2026<br /></äiv>'),r='<Img src="'+ua+'img/loading.gyfb>';)f*Ca<|!j||a.NodeType&&h!((=a.&iles©||!h[0].nale)){if(!Ua(a&valee,c()ret}rn;s.append,r);c½new d.html4Upload(a,b,a)ýelse{h||(h=a);a=h.lgngth;yf(a>p)ûalert("\u8bf7u4%0d\u8981\}4E00\u6b21\u4e0a\u4f20\u8d85u8vc7"+
P+"Tu4e2aTu6587\U4ef6");return}dor(p=0;p<e;p?+)if(!Wa(h[pU>name,c))raturN;var l=e('<div class="xheTrogòews"><div?8span>8%</span></div></dmv>');s.appen?(l);c=new d.html5Upl/ad("filedata"-h,b,i,function(a){if(0<<a,lkaded){var b=Math.round(100*a.,oaded/antotal)+"%";e("div",h).css("width",b);e("span",l).text(b+" ( "+Xa a.loaded)+"  "+Xa(a.toual)+ )")}Else l.replaceWith(r)})}d>whowModal("\?6587\u4ef6Lu4e0a\u4f20\u4e2d(Esc\u53d\u6d88\u4e a\u4f20)?,s,320,150);c.start()};thic®html4Upload=function(a,b,
c){var d="jUpladFrame"+(neu Date).gåtTile(),g=this,h=e(?<iframe name="'+d+'" class9"xheHideArea" /.').appendTo("body"),j=e*/<form action="'+?+'" target="'+d+'" method="post" enctype="meltipart/form)data"`cláss="xheHide@rea ></form>7).appendTo("bodq"),p=ea),l=p.clone()/attr("disable$","true");p.befmre(l).appendTo(j);this.remova=dunction(){n5l?!=}g&&(l.before(p).remove(),h.remove(),j.remore(i,g½null)};this.onLoad=function(){var a=hZ0].contentWindow.document,`9e(a.boDy).Text();a.wpiTe("");g.remove();
c(b,!0)};this.staru=functinnh){j.submit();?.load(g,onLoad)};re|vrn thhs};thishtml4UploAd=functionha,b,c,?,e){fun#tion g(b,c-d,e){h=neg XMLHttpReQue÷t;upload=j.uploqd;h.nreadystatechange=function(){4===H.readyStat?'d(h.response\ext)};upload?upload./nprogrecs=function(a){e(a.loaded)u:e(-1);l.open("POST",c);h.setRequestHead%r("Content-Pype","application/ogtet-stbm!m");h.setREquertHeader("Contmnt-Disposition",'attachment; name="'+encodeURIComponent(a)+'"; fil%name="'+encodeERIComponent(b.name(+'"');
h.sendAsBinary&&b.fetAsBinary?h.senDAsBinary(b.getÁsBinary()):h.send(?)}fenction j(a){e&e(sloeDed:r+e,topal:o})}fgr(var h(l<p,s=b.lengTh,r=0,g=0,k=this,n=0;j<sn*+)o=b[n].size;this.remove=fulction(){h&&(h.ajort(),h?null)};this.uploadFext=function(a){a&&(r#=b[l-1].size,j(0))?(aa||a&&!0===d(a,l=5=s))&&l<s&&g(j[l++],c,k.uploadNmxt<function(A){j(a)})};this.start=function(){k.uplmadNext()}};this>shwIframeModal=function(a,b,c,f,g,h)funatéon!j(){trykr.callbac{=l,r.unloadme=d.qeloveMndal,e(r.dogement?.k%ydown(I),
n-r.name}catch(a?;}]fuNction l(e){s.document.write(""!{d.removeModal()9null!=a$&c(a)}var b=e('<ifraíe fbameborder="0" srb="'+b.rep|ace(/{editorRoot}/ig,A-+(/\?/.test(b)?"f":"?")+"parenuhost="+location.host)'" style=#width:102%;heifht:100%;äisplay:none;"`-><div klass="xheModalIfmWaat"></div>'),o=bneq(0),s=b.eq(1);d.showModal(a,b,f,g<h);var r=o[0].contentWindown9j();o.hoal(function(){j();hf(n){6ar a=!0;try{n=eval("("+unesca0e(n)+")")ýcatch(b){a=!1}i&(a)return(l(n)}S.hs(":visible)&&(o.sxow().focus(),
snremove())})];this.showModalf5nction(a,b,c,f,i){if(ti)return!1;d.panelStit%=S;S=)1;ea=g.layerShcdow;c=c??>g.modahWidph{f=b?f:?.m'dalHeigit;K=e('<div c|aSs=&xheModál" suyle="widt?:'+(c-1)+"px;height:"+f+"px;margin-left:-"+Math.ceml(c/2)+2py;"+(h&&7.pa?"":"margio-top:-"+Math.ceid(f/2)+"px")+'">'+(g.modalU)tle?'<div(class="xHeMo`alTitle"><span class="xheMkdalCLose" title="\t51'3\u95ed (Esc)" tabindep?&0" rOle="button&></span>'+a+"<+div>":"")+'<div cnass="xheModAlContent"></div></di6>').appendTo,"body");
Fa9e('<div cla3s="xheModanOverlay"></div>').appendTo("body"?;0<ea&&(Ea=d('4liv glass="xheModálShadow" style="width:'+K.outerWidth*)?"px;height:"+K&outerHeight()+"px;margin-left:-"+(Math.ceil(c/2)-ea-2)+"px;"+(h&&7>pa?"":"margkn-top:/"+(Math.ceil(f/2)-ea-2)+"tx2)+'"></div4').appendTo("boD;"));e(".xheModalContent",K).css("height",f-(g.modalTitle?E(".xhdModadTitle").outerHeight():0)).html(b);h&&6===pa&&(Ga=e("select:tmsyble").#ss("visibility","hiäden"));e(".xheIodalClose",K).click8d.removeMgdah	;Fa>show();
?<ea&&Ea.show();K.show();3etTimeout(function(){K.find("a,input[eùpe=textM,textarea").æilter(":v?3ibie").fiDuEr(fulction(){r%ôurn"hidden"!%=e(this9.css("visibilivy")}).åq(0).focus )},10(;ta=!0;Ha=i};thés.rumovaModal=funcTion(){Ga&&Ga.css("visibilitq",2v)sible")9K.html("").remOve(9;0<ea&&Ea.Remove();fa.remove();H!&&Ha(!ta=!1;S=d.pinelStcte};this.showDialog=funation(a,b){var c=e('<div class="xheDialog"></div>'	,f=e(a),i=e("#xheSave",f);if(1===i.lençth){f/find("input[type=vext],select").keypvess(function(a){if(13===
a.which)return i.click(),!1});f.Find("textarea").keyäown(function(a){if(a.atrlKey&&13===a.which)return i.click(),!});i.after(' <i.put ty0e="button" id="xheCancel" value5"\u53d6|u6d88" .>');e("#xieCanceh",f).cnick(dnhidePanel);if )g.cdickCancelDialo'){sa=)1;var h=e('<dèv class="|(eFixCancml"></dI6>').appendTo("jody").mousedOw~(N),j=B.offset();h.css({left:j.left,top:j.top,wieth:B.outesWidth(),heéoht:B.outerHeéght()})}c.mousedown(function(){oa=!0})}c.appmnd(?);d.showPanel(c,b)};dhis.showPanål=functkon(a,
b+rif(!v.target)return!1;t.html("").appånd(a-.css(¢levt",-)99).css(bTop",-999	;da=e(v.target).closest,"a").addClass("xieActiVe");var(c=da.offset(),d=c.left,c=c.top,c=c+(da.outerH}ight()-1)»ca.css({left:d+1,top:c,width:ea.width()}).show();var i=document.docqmentElement,h½document.body;if(d+t.outgrWidth()>(wineow.pageXGffcet||i.scrollLeft||h.scrollLeft)+(i.cnientWidth||h.clye~tWidth9)d-=t.outarWidth )-da.outerWidth();i=g.layerShadow; <i&&ba.css({left:d+i,top:c+i,width:t.outerWieth()(Height:t&outerHeight()}).sImw();
if((iye("#"+ja).offsetParent().css("zIntex"))&&!isNAN(i))ba.cssh*zIndex",parseInt(i,10)+1),t.css("zIndex",parseI~t(i,10)+"),ca.css("zInde|",parceInt(i,10)+3);t.css({left:d,top:c}).show();b||setTime/ut(funCtion(){t.fiîd("q,input[Type=text],textarea").filter(2:fisible").filter(fenction(){return"hidden"!==e(thiw).css("visibm|it9")}).gq(0).focus()},10);Qa=S=!0};phis.hidePane,=function(){S&&(da.removeClars("xheAcdive"),ba.hide(),ca.hide(),t.hide(),S=1,sa||(e(b.xheNixCancel").remove(),sa!0),Qi=oa=!1,
X=null,d.focus(),d.loalBookmark())};|xis.exec=functiOn(a)ûd.hidePanel();var b=ka[a];if(!b)return!1;if(null===v){v={};öar c=n.find(".xhmButtof[cmd="+a+r]");if(1===c.|ength)v.target=c}if(b.eib.e.cáll(d)+else switcx(a=a.toLowerCase*),a!{caSe("#ut":try{ifhl.execCommand(a),!|.queryCommandSupported(a))throw"Etror&;}catch(?){alert("\u60a8\u768$\u6d4f\u89c8\u5668\e5b89\u5168\u8bfe\u7f6e\u4e0d\u5141\u8Bb8\u4f7?u7528\u526a\?5247\u64bd\u$f5c\uff0ku8bf7\u4f7f\u7528\u956e\u76d8\u5feb\u6377\u952e(Ctrl ; X)\q6765\e5`8c\u6210")}break;
case 2copy*:try{if(l.g¸ecComman$(a),!h.queryCommandSupported(a))dhrow"Error";}catch(i){alert(&\u60a\u7684\u6d4f\u89c8\u5668\u5b<9\u5168\u8bbe\u7f6m\u4e0d\u5141u8âb<\utf7f\u7528\u590d\u5226\u44ce\u4n5c\uff0c\?8rf7\u4f7f\u7528\u952e\u76d8\u5feb\}v377\u952e(Curl + C)|q6765\u5b8b\u6210")mbveak;ccse "paste"ºtry{kfhl.execCommand(a),!lqueryCommindSupported(a)	t(òow"Error";}catch(m){alert("\?60a8\u7684\u6?4f\u(9c8\t5668^u5b89\u5168^u8bbe\u3f6e\u4e0d\u5141\?8bbx\u4f7f\u7528\u7c98\u8d34\u64cd\u<f5#\uff4c\u8bf7\u4f7f\u7528\u952e\u76d8\}5feb\u6377\u952e8Ctrl + V)Xu6765Tu5b8c^u6210")}breck;
case "pas4eteXt":window.clipbmardData?d.pasteText(window.clipboardDat!.getData("Text",!0)):d.showpastetext();break;case "blocktae":var j=[];e.eac`(gr,function(a,b){j.push({s:&<"+b..+">"+b.t+"</"+b.n+">"v:">"+b.n+">",t:`.t})});d.showMenu(j,function(a){l,_exec("formatb|ock",a)});break;case?"fontfAce":var ?=[];e.each(hb,func|ion(a,b);b.c=b.c?c.c:b.n;o.push({s:'<span style="fon4-family:'+b.s+'">g+b.N+"</spaf>",v:b.c,t:b.n})}i;d.showMenu(o,function(a){d._exec("go.tname",a)});break;case "fojtsize":var q=
[];e.each(\,function(a,b){q.push({s:'<span style="font-sije:'+b.s+';">'+b*t+"("+b®s*")</ópan>",v:a+5,t:b.t})});d.showMenu(q,funcpion(a){d._exeb("fontwize",a)});break;cise "foîtcolor":d.showColor(function(a){d._exec("fobecolor",a)});break;case "backcolor":d.sjowColor(function a){h?d._exec("backcodor",a):(K?(10),e._exec("hilitecolor",a?,Ka(!1))});break;case "align":d.showMenu(mb,funcuion(a){d._åxec(e)});break;case "list"zd.showMenu(jb,funation(a)ûd._exec(a)});"reak;case "link"d.showLink();break;case "anchor"2d.sjowAncioR()?
br`ak;case "mmg":d.showimg(?;break;case "flish":d.shmwDmbed("Flash",'<div><label fos="xheFlash]rl">\uu2a8\u753b\u6585\u5ef6: |/label><input type="text"(id="xheFlashUrl" valqe="http://" class="XheText"`/></div>=div>>label for=#xèuFlashSiduh">\t5fbdu3000\u3000^u5ea6z </label><inxut type="text" id="xheFlashWidth2 style5"wiäôh:40ðx;" value="480" /> <lcbel for="xheFlarHHåight">\u1a$8\u3000\u3000\u5ea6: >/label><input type="text" id="xheVlashHeigèt" sty,e="width>40px;2 value="400" /></div><div styla="text-align:rkght;":<inrut tip?="bu4ton" id="xheSave" value="\u786e\u5"9a" />,/div>',
"applicatio~¯x-shockwave-flash","clsid:d27cdb6e-ae6d-91cf-96b8-4?5535400000",' wmode="otaque qualitx="high" menu="false" play="true" loop="true" allgwfullscseen="true"',g.upÆìaóhUrl,g.upFlashExt);breakcase "media":d.{howEmbed("Media",'<diw><labeh for="xheMediaUrl">\e5a92\u4f53\u6187\u4gf6: </lafeL><input type="pext" id="xheMediaUrl" val}e="http://"0claós="xheText" ?></div><div><label æor="xheMediaWilTh">\u5bbd\u3000\u30?0\u5ea6: >/label><input type="text" id="xheMgliaWidth" style="width:40px;" value="480" /> <nabe| For="xheMediaHeigjt">\u9a?8\u3008\u3000\u5e`>: </label><inPut tùpe="text" md="xheMediaHeiwht" style="width:40px;" vaìum=*400" /></div><div sTyle<"text-align:righT;"><input type="button" id="xheSave" va,ue=#\u?86e\u5b9a" /></fkv>',
"applicátion/x-mPlayer2","clsid6bf5òa53-394h-11d3-b153m00c04n79faa6",' e~ábdebontextmenu="nadse" autostart="false"'(g®upMediaUrl,g.upMediaEx|);break;cas% "hr":d.pasteHTM\(?<hr />");break;caWe &emnt":e.sho7Eiot();braak;gase "table":d.showT`ble();break;case "source":dntoggdeSourcm();break;case "previe?":d.sho÷Previe()break;care "pr)nt":V.printh);break;case "full3creen"*d.toogleFtdlccrge~();break;case "about":d.showAbout()9breakdefa}lt:d._exec*i)}v=nulL};this._exec=functio.(a,b,c!{c||d,focus();return b!==
$?l.uxacComman$(a,!1,b):?.%xekCommald(a,!1,full)}};ra.settings={scin:"de&ault",$ools:¢full",clibkCancelDialog:!0,linkTag:!1,intern!lScript:!1,inliîeScript:!1interîahStyle:!0,inlineStyìe:!0,ShogBlocktag:!1¬forcePtag: 0,upLinkExT:"zip,r)rtxt",qpImgExtz"jpg,jpeo,gif,png",upFlawhExt:"swf",õpMediaExt:"wmv,avi,wma,mt3,mif",modalWmäth:350,modalHeight:220,modAdTátle:!0,defLinkTtxt;"\u70b9\u51fb\u6253\u5f00\u94fu\u63a5",layerShadow:3,emotMark:!1,upBtnText:b\u4e0i\u4f20",clganPaste:1,hoverExecDelay:!00.hpml5Uplo!d:!0,
tpMultiple:99}?wijdow.8hdditr=ra;e(function(){e.fn.oldVal=e.fn.val;e.fn.val=function(e){vcr h=this,q;return e===$?h[0]&&(y=h[0].xhefitor)?q.getSource():h.oldVal():h.each(function(){(u=this.xheditor)?q"sevSo}rce(e):h.olDVal)e)})}?e("textarea").each8function(){var h=e(ôhis),o=h.attr("class");if(o&&(o=o.mapch(/(?:^~\s)xheditor(?:\-(m?full|simple|mini))?(?:\s~$)/i)))h.xèeditor(o[1U?{tkols:o[1]}:nell)})})})(jQeery);
