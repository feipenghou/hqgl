   ...
   <table width="80%" cellspacing="0" align="center">
				<tr >
					...
					<td width="10%" height="35" align="center">礼服编号：</td>
						<td width="35%" style="padding-left:20px;"><%=fuzhuang.getId()%></td>
						<td width="10%" height="35" align="center">礼服类型：</td>
						<td width="35%" style="padding-left:20px;"><%=fuzhuang.getType()%></td>
						</tr>
						<tr>
						<td width="10%" height="35" align="center">礼服颜色：</td>
						<td width="35%" style="padding-left:20px;"><%=fuzhuang.getPhoto()%></td>
						<td width="10%" height="35" align="center">礼服尺码：</td>
						<td width="35%" style="padding-left:20px;"><%=fuzhuang.getLipin()%></td>
						</tr>
					
						
							<tr><td  width="10%" height="100" align="left">
					礼服介绍：</td>
					<td colspan="4"  style="padding-left:20px;"><%=fuzhuang.getJianjie()%>
						    
					</td>
				</tr>
				<tr><td  width="10%" height="160" align="center">
					礼服价格：</td>
					<td   style="padding-left:20px;"><%=fuzhuang.getMoney()%></td>
					<td  width="10%" height="160" align="center">
					礼服图片：</td>
					<td style="padding-left:20px;"><div class="image"><image src="upload/<%=fuzhuang.getZhaopian()%>"></div></td>
					
				</tr>
					<tr height="30px">
					<td colspan="4" align="center">
    <input type="button" onClick="location='ptfuzhuang_display.action'" style=" height:23px; width:50px;" value="返回"></input>
				</tr>
			</table><br>
  </body>
</html>
