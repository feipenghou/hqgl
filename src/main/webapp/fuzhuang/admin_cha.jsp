...
<table width="85%" cellspacing="0" align="center">
    ...
    <tr>
        ...
        <td width="10%" style="padding-left:5px;"><%=user.getName() %>
        </td>
        <td width="10%" rowspan="6" align="center">
            <div class="image">
                <image src="upload/<%=user.getPhoto()%>">
            </div>
    </tr>
    <tr>
        <td width="10%" height="30" align="center">性别：</td>
        <td width="10%"><%=user.getSex()%>
        </td>
        <td width="10%" height="30" align="center">出生日期：</td>
        <td width="10%"><%=user.getBirthday()%>
        </td>
    </tr>
    <tr>
        <td width="15%" height="30" align="center">民族：</td>
        <td width="10%" style="padding-left:5px;"><%=user.getMinzu() %>
        </td>
        <td width="10%" height="30" align="center">学历：</td>
        <td width="10%" style="padding-left:5px;"><%=user.getXueli()%>
        </td>
    </tr>
    <tr>
        <td width="15%" height="30" align="center">密码：</td>
        <td width="10%" style="padding-left:5px;"><%=user.getPass()%>
        </td>
        <td width="10%" height="30" align="center">身份证号：</td>
        <td width="10%" style="padding-left:5px;"><%=user.getShengfen()%>
        </td>
    </tr>
    <tr>
        <td width="15%" height="30" align="center">联系电话：</td>
        <td width="10%" style="padding-left:5px;"><%=user.getPhone()%>
        </td>
        <td width="10%" height="30" align="center">电子邮箱：</td>
        <td width="10%" style="padding-left:5px;"><%=user.getEmail()%>
        </td>
    ...
    <tr>
        ...
        <td height="100" colspan="4" style="padding-left:10px;"><%=user.getJianjie()%>
        </td>
    </tr>
    <tr height="30px">
