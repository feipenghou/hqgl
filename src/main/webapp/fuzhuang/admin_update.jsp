 ...
 */
 ...
 <script type="text/javascript" src="fuzhuang/My97DatePicker/WdatePicker.js"></script></head>
...
<td width="10%" ><input type="text" size="10" class="Wdate" onClick="WdatePicker()" name="birthday" value="<%=user.getBirthday()%>" ></td>
	...
	<td width="10%" style="padding-left:5px;"><input type="password" size="12" value="<%=user.getPass()%>" name="pass" ></td>
		...
		<td colspan="4"width="10%" style="padding-left:5px;" ><input type="text" id="shengfen" size="18" value="<%=user.getShengfen()%>" name="shengfen" ></td>
		...
		<td colspan="6" width="10%" style="padding-left:5px;" >
		...
		<tr>
		<td width="15%" height="35" align="center">个人简介：</td>
		<td colspan="6" style="padding-left:10px;">
						<textarea name="jianjie" style="width:575px;height:100px;font-size:12px;line-height:25px;"  >
  						<%=user.getJianjie()%>
  						</textarea>    
					</td></tr>
					<tr height="30px">
