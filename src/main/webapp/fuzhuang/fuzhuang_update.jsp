...
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" style="FILTER: progid:DXImageTransform.Microsoft.Gradient(gradientType=0,startColorStr=#f2c7da,endColorStr=#ffffff)">	
   <div style="height:30px;font-size:12px;padding-top:30px;padding-left:30px;">&nbsp;当前位置:&gt;<strong>&gt;修改礼服</strong></div>
   ...
   %>
    	<table width="80%" cellspacing="0" align="center">
				...
				<td width="10%" height="35" align="center">
						礼服编号：</td>
						<td   style="padding-left:20px;background-color:#cccccc;"><%=fuzhuang.getId()%></td>
				</tr>
				<tr>
				<td width="10%" height="35" align="center">
						礼服类型：</td>
   ...
   <input type="radio" name="photo" value="白色" checked="checked"/>白色
	...
	<input type="radio" name="photo" value="绿色" />绿色
				...
				<td  style="padding-left:10px;">
						<textarea name="jianjie" style="width:490px;height:100px;text-align:left;font-size:12px;line-height:20px;"  >
						<%=fuzhuang.getJianjie()%>
  						</textarea>    
					</td>
				</tr>
   ...
   <input type="radio" name="lipin" value="S" checked="checked"/>S
	...
	<input type="radio" name="lipin" value="XXL" />XXL
				...
				<td width="10%" height="35" align="center">
						礼服价格：</td>
						<td style="padding-left:10px;"><input type="text" size="8" name="money" value="<%=fuzhuang.getMoney()%>" >
