...
.image{
 ...
 <body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" style="FILTER: progid:DXImageTransform.Microsoft.Gradient(gradientType=0,startColorStr=#f2c7da,endColorStr=#ffffff)">	
   <div style="height:30px;font-size:12px;padding-top:30px;padding-left:30px;">当前位置:&gt;<strong>&gt;详细用户资料</strong></div>
    <%
  		List list=(List)session.getAttribute("ptlist");
   ...
   %>
	<table width="85%" cellspacing="0" align="center">
		...
		<td width="10%" style="padding-left:5px;"><%=user.getName() %></td>
		  ...
		  <div class="image"><image src="upload/<%=user.getPhoto()%>" ></div>
		</tr>
		<tr>
		...
		<tr>
		<td width="10%" height="30" align="center">民族：</td>
	...
	<td width="10%" style="padding-left:5px;"><%=user.getPass()%></td>
		...
		<tr>
		<td width="10%" height="100" align="center">个人简介：</td>
		<td height="100" colspan="4" style="padding-left:10px;"><%=user.getJianjie()%></td></tr>
